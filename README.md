...
\033[1;96m▇▇▇◣╲▇╱◢▇▇▇
/033[1;96m▇▇▇▇◣▇◢▇▇▇▇
\033[1;47m\033[1;31m      Your Mind Your Power I fuck Your System       \033[1;0m
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;41m3\033[1;37m         Type python2 cyberbox.py          \033[1;0m")
    time.sleep(0.05)
	...
	if black =="":
		...
		clear()
	        ...
	        love("\033[1;93mTool User Name :\033[1;95m     silent ")
                ...
                time.sleep(5)
                os.system("cd $HOME/402 && python2 cyberbox.py")
	elif black =="2":
	        clear()
	        print(logo)
		...
		time.sleep(5)
	        ...
	        clear()
		print(logo)
		os.system("rm -rf $HOME/cyberbox")
		os.system("cd $HOME && git clone https://github.com/noyon14/cyberbox")
                print (logo)
		love("\033[1;96mCongratulations cyberbox Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
                os.system("cd $HOME/cyberbox && python2 cyberbox.py")
        elif black =="19":
		clear()
		print(logo)
		os.system("rm -rf $HOME/cyberbox")
